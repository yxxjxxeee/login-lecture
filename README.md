...
#### 데이터 관리
- JSON 파일을 간단한 DB처럼 사용
- AWS RDS(MySQL) 연결 실습(DB 클라우드 활용)
- `.env`로 DB 정보 보안 관리

#### API & 요청 처리
- `fetch`를 이용해서 클라이언트에서 서버로 요청 전송
- 서버에서 응답을 받고 DOM에 표시
- RESTful API(GET, POST) 구현
...
#### 회원가입 페이지
<img src="./img/register.png" alt="signup-page" width="800" />

#### 로그인 성공 페이지
<img src="./img/login-success.png" alt="login-success" width="800" />
